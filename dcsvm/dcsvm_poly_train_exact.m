function [model] = dcsvm_poly_train_exact(trainy, trainX, C, gamma, degree)
...
%level_stop=0  %% the final solution, usually no needed. 
kk = 4; %% will be used if mode=1
ncluster = 10; %% will not be used if mode=1
